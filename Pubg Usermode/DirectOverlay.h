...
#define offs_uworld 0x7593728 //48 89 05 ? ? ? ? 48 83 C4 28 C3 B8 ? ? ? ? 48 C7 44 24 ? ? ? ? ? 66 C1 C8 08
#define offs_localplayer 0x76BE1A0 //48 89 3d ? ? ? ? f2 0f 10 05 ? ? ? ?
#define offs_gnames 0x7815CC8
#define offs_decrypt 0x52D5728
#define offs_chunk 0x3F58

#define offs_PersistentLevel          0xA8 //E8 ? ? ? ? 39 5C 24 48 
#define offs_ActorsArray              0x288 //E8 ? ? ? ? 39 5C 24 48 7E 29
#define offs_PlayerControllers        0x30
#define Offs_LocalPawn				  0x438 //8B 90 ? ? ? ? C1 EA 04 41 84 D4
#define offs_PlayerCameraManager      0x4B0 //41 ff 90 ? ? ? ? ? 8b ? ? ? ? ? 48 85 c9 74 ? 48 8b 01 4c 8d
#define offs_Actor_ObjID			  0x8
#define offs_Actor_Health			  0xC58 //0F 57 C0 0F 2F 81 ? ? ? ? 72 0C
#define offs_Actor_RootComponent	  0x108 //E8 ? ? ? ? B0 01 48 8B 4D 00 
#define offs_Actor_TeamNumber		  0x1690
#define offs_Mesh					  0x4C0 //48 8B 99 ? ? ? ? 48 ? ? 48 ? ? 0F 84 ? ? ? ? 0F 10
#define offs_Mesh_BoneArray		      0xAC0 //F3 0F 10 81 ?? ?? ?? ?? F3 0F 10 0D ?? ?? ?? ?? 0F 2F C1
#define offs_Mesh_ComponentToWorld    0x250 //0F 8D ? ? ? ? 0F 10 9F ? ? ? ?
#define offs_relativepos			  0x2D0
#define offs_absolutepos			  0x260
#define offs_CameraRotation		      0x15B0 //f2 0f 10 81 ? ? ? ? f2 41 0f 11 ? 8b 81 ? ? ? ? 41 89 ? ? c3
#define offs_CameraLocation		      0x1024 //E8 ? ? ? ? 44 8B 8F ? ? ? ? 0F 28 D6
#define offs_CameraFov			      0x9D4 //77 08 F3 0F 10 81 ? ? ? ? C3 CC CC CC CC CC CC CC 48 89 5C 24 ?
#define offs_UANIMINSTANCE			  0xC68
#define offs_CONTROL_ROTATION_CP      0x6A0
#define offs_RECOIL_ADS_ROTATION_CP   0xB48

//items
#define offs_DroppedItem              0x288
...
#define offs_ITEM_PACKAGE             0x530

//prediction
#define offs_WEAPONPROCESSOR 0xFC8
#define offs_EquippedWeapons 0x2A8
#define offs_WEAPONTRAJECTORYDATA 0xF40
#define offs_TRAJECTORYCONFIG 0xB0
#define offs_COMPONENT_VELOCITY 0x200
